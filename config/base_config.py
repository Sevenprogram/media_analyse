...
CRAWLER_SORT_MODE = "relevance"
CRAWLER_TIME_PRESET = "all"
CRAWLER_TIME_START = None
CRAWLER_TIME_END = None
...
# JustOneAPI third-party data source.
# This is kept separate from TikHub because some integrations still rely on
# TikHub-specific routes and auth behavior.
ENABLE_JUSTONE_API = False
JUSTONE_API_KEY = ""
JUSTONE_BASE_URL = "https://api.justoneapi.com"
JUSTONE_TIMEOUT_SECONDS = 60
JUSTONE_MAX_RETRIES = 3
JUSTONE_RETRY_BACKOFF_SECONDS = 2
