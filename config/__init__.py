...
from .db_config import *  # noqa: E402,F403
...
ENABLE_JUSTONE_API = _env_bool("ENABLE_JUSTONE_API", ENABLE_JUSTONE_API)
JUSTONE_API_KEY = os.getenv("JUSTONE_API_KEY", JUSTONE_API_KEY)
JUSTONE_BASE_URL = os.getenv("JUSTONE_BASE_URL", JUSTONE_BASE_URL)
JUSTONE_TIMEOUT_SECONDS = int(os.getenv("JUSTONE_TIMEOUT_SECONDS", JUSTONE_TIMEOUT_SECONDS))
JUSTONE_MAX_RETRIES = int(os.getenv("JUSTONE_MAX_RETRIES", JUSTONE_MAX_RETRIES))
JUSTONE_RETRY_BACKOFF_SECONDS = float(
    os.getenv("JUSTONE_RETRY_BACKOFF_SECONDS", JUSTONE_RETRY_BACKOFF_SECONDS)
)
