    ...
    async def ingest_xhs_batch(
        ...
        *,
        ...
        return await self._ingest_batch(
            ...
            comments=comments,
            authors=authors,
            post_normalizer=normalize_xhs_note,
            comment_normalizer=normalize_xhs_comment,
            author_normalizer=normalize_xhs_author,
            post_id_key="note_id",
            post_url_key="note_url",
            comment_id_key="comment_id",
            author_id_key="user_id",
    ...
    async def ingest_douyin_batch(
        ...
        *,
        ...
        return await self._ingest_batch(
            ...
            comments=comments,
            authors=authors,
            post_normalizer=normalize_douyin_aweme,
            comment_normalizer=normalize_douyin_comment,
            author_normalizer=normalize_douyin_author,
            post_id_key="aweme_id",
            post_url_key="aweme_url",
            comment_id_key="comment_id",
            author_id_key="user_id",
            time_window=time_window,
        )

    async def ingest_kuaishou_batch(
        self,
        *,
        job_id: int,
        ...
        return await self._ingest_batch(
            ...
            comments=comments,
            authors=authors,
            post_normalizer=normalize_kuaishou_video,
            comment_normalizer=normalize_kuaishou_comment,
            author_normalizer=normalize_kuaishou_author,
            post_id_key="video_id",
            post_url_key="video_url",
            comment_id_key="comment_id",
            author_id_key="user_id",
            time_window=time_window,
        )

    async def ingest_bilibili_batch(
        self,
        *,
        job_id: int,
        videos: list[dict[str, Any]],
        ...
        return await self._ingest_batch(
            ...
            comments=comments,
            authors=authors,
            post_normalizer=normalize_bilibili_video,
            comment_normalizer=normalize_bilibili_comment,
            author_normalizer=normalize_bilibili_author,
            post_id_key="video_id",
            post_url_key="video_url",
            comment_id_key="comment_id",
            author_id_key="user_id",
    ...
    async def ingest_tieba_batch(
        ...
        *,
        ...
        return await self._ingest_batch(
            ...
            comments=comments,
            authors=authors,
            post_normalizer=normalize_tieba_note,
            comment_normalizer=normalize_tieba_comment,
            author_normalizer=normalize_tieba_author,
            post_id_key="note_id",
            post_url_key="note_url",
            comment_id_key="comment_id",
            author_id_key="user_id",
