...
class AbstractCrawler(ABC):
    ...
    @abstractmethod
    async def launch_browser(self, chromium: Any, playwright_proxy: Optional[Dict], user_agent: Optional[str], headless: bool = True) -> Any:
        """
        launch browser
    ...
    async def launch_browser_with_cdp(self, playwright: Any, playwright_proxy: Optional[Dict], user_agent: Optional[str], headless: bool = True) -> Any:
        """
...
class AbstractApiClient(ABC):
    ...
    @abstractmethod
    async def update_cookies(self, browser_context: Any):
        pass
